...
//  Story Book
//
//  Created by Ashan Anuruddika on 6/3/20.
...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        guard let newWindow = (scene as? UIWindowScene) else { return }
        
        window = UIWindow(frame: newWindow.coordinateSpace.bounds)
        
        window?.windowScene = newWindow
        ...
        if Auth.auth().currentUser != nil{
            ...
            homeStoryboard.localizeResouce = "si"
            ...
            window?.rootViewController = loginStoryboard
        }
